const kittens = [
    {
        ...
        age: "2 mois",
        price: "1 200 €",
        description: "Léo est un petit mâle très calme et affectueux. Il adore les câlins et a déjà commencé sa socialisation avec d'autres animaux.",
    ...
    },
    {
        ...
        age: "3 mois",
        price: "950 €",
        description: "Misty est une femelle pleine d'énergie et très bavarde, typique de sa race. Elle cherche une famille joueuse.",
    ...
    },
    {
        ...
        age: "2.5 mois",
        price: "1 500 €",
        description: "Simba est déjà un grand gabarit pour son âge. Très sociable, il fera un compagnon de vie exceptionnel.",
    ...
    },
    {
        ...
        age: "2 mois",
        price: "1 300 €",
        description: "Nala porte bien son nom de Ragdoll : elle devient une vraie poupée de chiffon dès qu'on la prend dans les bras.",
    ...
    },
    {
        ...
        age: "3.5 mois",
        price: "1 800 €",
        description: "Oscar est un petit léopard de salon. Très intelligent et actif, il a besoin d'espace pour s'épanouir.",
    ...
    },
    {
        ...
        age: "2 mois",
        price: "1 100 €",
        description: "Bella est la douceur incarnée. Son pelage nécessite un entretien régulier qu'elle apprécie énormément.",
...
function renderKittens() {
    ...
    if (grid) {
        grid.innerHTML = kittens.map(kitten => `
...
function closeModalAndContact(id) {
    closeModal();
    document.getElementById('kitten-interest').value = id;
...
if (contactForm) {
    contactForm.onsubmit = (e) => {
        ...
        formStatus.innerHTML = `<span style="color: green;">Merci ${name} ! Votre demande a été envoyée avec succès. Nous vous recontacterons bientôt.</span>`;
        contactForm.reset();
...
function revealOnScroll() {
    const cards = document.querySelectorAll('.card, .about-container, .testimonial-card');
    cards.forEach(card => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animElements = document.querySelectorAll('.card, .about-container, .testimonial-card');
